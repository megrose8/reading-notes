...
##### Format of Syntax Key: Description, Syntax, Example
...
Adding a Link, [Language to Appear] (Links to an external site.) , Example: My GithubLinks to an external site..
...
###### Figure 2: Smallest HeadingLinks to an external site.
